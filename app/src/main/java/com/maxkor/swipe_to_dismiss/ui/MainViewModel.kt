...
class MainViewModel : ViewModel() {
    ...
    private val _itemCardState: MutableState<ItemCardState> =
        mutableStateOf(ItemCardState.Initial)

    val itemCardState: State<ItemCardState> = _itemCardState
    ...
    init {
        _itemCardState.value = ItemCardState.Edit
    }
